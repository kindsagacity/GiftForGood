    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status === 'success') {
                ...
                setTimeout(function () {
                    $('#submit_login').prop('disabled', false);
                    location.href = '/secret/verification-phone';
                }, 1500);
...
function registerPost() {
    ...
    let register_url = '/secret/register';
    let data = {
...
function submitPhoneVerify() {
    ...
    let url = '/secret/verification-phone';
    $.ajax({
        url: url,
        method: 'post',
        data: {
...
function submitPhoneVerifyCode() {
    ...
    let url = '/secret/verification-phone-code';
    $.ajax({
        url: url,
        method: 'post',
        data: {
